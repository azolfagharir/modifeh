...
function Header(){
    ...
    return(
        <>
    <div className="">
        <p className=" absolute right-4 top-4 shadow-2xl">Alex Fergosen</p>
    <svg className=" absolute right-32 top-3 shadow-2xl" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <img src="/envelope.jpg" className="absolute top-5 w-8 right-56 shadow-2xl" alt="envelope" />
    <img src="/bell.png" className="absolute w-8 top-6 right-72 shadow-2xl" alt="bell" />
    
    <form method="POST" className="absolute top-6 left-96 shadow-2xl">
        <input type="text" className="rounded-full border-2 w-searchBox shadow-2xl " placeholder="  Search" />
    </form>
